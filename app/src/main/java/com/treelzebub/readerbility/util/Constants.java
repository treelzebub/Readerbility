...
public class Constants {
    ...
    protected static final String CALLBACK_URL = "com.treelzebub://readability";
    ...
    protected static final String USER_AGENT = "Readerbility for Android v0.001";
    protected static final LogLevel LOG_LEVEL = LogLevel.BASIC;
